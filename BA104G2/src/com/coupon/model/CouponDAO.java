...
public class CouponDAO implements CouponDAO_interface {
	...
	private static final String GET_COUPON_APPLY = "SELECT * FROM COUPON WHERE COUPON_STATUS='省核中'";

	private static final String GET_COUPON_FINISH = "SELECT * FROM COUPON WHERE COUPON_STATUS NOT LIKE '省核中'";
	...
	private static final String UPDATE_COUPON_STATUS_PASS = "UPDATE COUPON SET COUPON_STATUS ='省核通過' WHERE Coupon_num = ?";
	...
	private static final String UPDATE_COUPON_STATUS_NOPASS = "UPDATE COUPON SET COUPON_STATUS ='省核失敗' WHERE Coupon_num = ?";
